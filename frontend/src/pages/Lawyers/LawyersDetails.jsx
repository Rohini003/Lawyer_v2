...
import ProfileImage from "../../assets/images/lawyer44.jpg"
        ...
        <div className="grid md:grid-cols-3 gap-[50px]">
          <div className="md:col-span-2">
            <div className="flex items-center gap-5">
              ...
              <div>
                ...
                <p className="text_para text-[14px] leading-6 md:text-[15px] lg:max-w-[390px]">
                  I am the best lawyer in town , contact me after commiting  crime.
                </p>
              </div>
            </div>
            ...
            <div className="mt-[50px]">
              {tab === "about" && <LawyerAbout about="Yash Bangar" />}
